...
const eventListeners = () => {
  ...
  document.querySelector("#filterContainer").addEventListener("click", (e) => {
    ...
    // if click a button it filters on that thing

    const filterHelper = (filterString) => {
      // filter to only have our videos from the music category
